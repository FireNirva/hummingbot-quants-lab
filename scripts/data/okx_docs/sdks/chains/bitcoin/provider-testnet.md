# Provider API (Testnet) | Bitcoin | 连接浏览器插件钱包 | 接入 Web3 钱包 | DEX API 文档 | 欧易

**URL:** https://web3.okx.com/zh-hans/build/dev-docs/sdks/chains/bitcoin/provider-testnet#signpsbts  
**抓取时间:** 2025-05-27 07:11:39  
**字数:** 526

## 导航路径
DApp 连接钱包 > Bitcoin > Provider API (Testnet)
...
```html
<div class="routes_md__xWlGF"><!--$--><h1 id="provider-api-(testnet)">Provider API (Testnet)<a class="index_header-anchor__Xqb+L" href="#provider-api-(testnet)" style="opacity:0">#</a></h1>
