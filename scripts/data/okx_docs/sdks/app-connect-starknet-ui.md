# UI | Starknet | 连接App或Mini钱包 | 接入 Web3 钱包 | DEX API 文档 | 欧易

**URL:** https://web3.okx.com/zh-hans/build/dev-docs/sdks/app-connect-starknet-ui#签署交易并广播上链-sendtransaction  
**抓取时间:** 2025-05-27 05:48:17  
**字数:** 798

## 导航路径
DApp 连接钱包 > Starknet > UI
...
<p>请确保更新OKX App到 6.98.0版本或以后版本，即可开始接入：</p>
...
<ul>
<li>namespaces - [namespace: string]: ConnectNamespace ; 请求连接的可选信息， starknet系的key为"starknet"，目前只支持starknet:mainnet，如果请求的链中，有任何一个链钱包不支持的话，钱包会拒绝连接<!-- -->
<ul>
    ...
    namespaces<span class="token operator">:</span> <span class="token punctuation">{</span>
        starknet<span class="token operator">:</span> <span class="token punctuation">{</span>
            chains<span class="token operator">:</span> <span class="token punctuation">[</span>
                <span class="token string">"starknet:mainnet"</span>
            <span class="token punctuation">]</span><span class="token punctuation">,</span>
