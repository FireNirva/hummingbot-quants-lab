# 广播交易 | API 参考 | 交易上链 API | 交易 API | DEX API | DEX API 文档 | 欧易

**URL:** https://web3.okx.com/zh-hans/build/dev-docs/dex-api/dex-onchain-gateway-api-broadcast-transaction#广播交易  
**抓取时间:** 2025-05-27 04:54:20  
**字数:** 118

## 导航路径
DEX API > 交易 API > API 参考 > 广播交易
...
#
将交易广播到链上。
交易广播API仅向我们的企业客户提供。如果您感兴趣，请联系我们
dexapi@okx.com
。
请求路径
#
POST
https://web3.okx.com/api/v5/dex/pre-transaction/broadcast-transaction
请求参数
#
Parameter
Type
...
"orderId"
:
"0e1d79837afce1e149b6ab54b6e2edce8130c3f8"
}
]
,
"msg"
...
<span class="token string">  "address": "0x238193be9e80e68eace3588b45d8cf4a7eae0fa3",</span>
<span class="token string">  "signedTx": "0x02f8720182029f8411e1a3008504bbe2e94682520894d73c5e36d47eed32f0327f9d3f04b49384e90fab85e8d4a5100080c080a0ba380a9be31efabc4c8cfccbb555f8af3c21073d6eca01f180ebebb8942c6f30a0779e6e16a504c413cb9902ceb33ab7e89a533bc13b74477dfa6b6c76dc41fac2"</span>
<span class="token string">}'</span>
    ...
    <span class="token property">"data"</span><span class="token operator">:</span> <span class="token punctuation">[</span>
        <span class="token punctuation">{</span>
            <span class="token property">"orderId"</span><span class="token operator">:</span> <span class="token string">"0e1d79837afce1e149b6ab54b6e2edce8130c3f8"</span>          
        <span class="token punctuation">}</span>
    <span class="token punctuation">]</span><span class="token punctuation">,</span>
    <span class="token property">"msg"</span><span class="token operator">:</span> <span class="token string">""</span>
<span class="token punctuation">}</span>

</code></pre></div></div></div><div class="index_sm-footer__Mk-6b"><div data-ssr-id=":R2lf:"><div class="md:flex md:justify-between index_web3-pagination-footer__9BwqX"><a class="flex items-center justify-start grow index_last__rkE9+" href="/zh-hans/build/dev-docs/dex-api/dex-onchain-gateway-api-gas-limit" target="_self"><i aria-hidden="true" class="icon iconfont doc-ssr-okds-arrow-chevron-left-centered-md index_icon__B+vCh" role="img" style="margin-right:8px"></i><div><span class="truncate-2 index_f-16__mSYje">获取 Gas Limit</span></div></a><a class="flex items-center justify-end grow index_next__Bv5Lh" href="/zh-hans/build/dev-docs/dex-api/dex-onchain-gateway-api-orders" target="_self"><div><span class="truncate-2 index_f-16__mSYje" style="padding-right:8px">获取广播订单列表</span></div><i aria-hidden="true" class="icon iconfont doc-ssr-okds-arrow-chevron-right-centered-md index_icon__B+vCh" role="img"></i></a></div></div></div></div></div><!--/$--></div>
```
