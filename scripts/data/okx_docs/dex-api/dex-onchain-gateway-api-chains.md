# 获取支持的链 | API 参考 | 交易上链 API | 交易 API | DEX API | DEX API 文档 | 欧易

**URL:** https://web3.okx.com/zh-hans/build/dev-docs/dex-api/dex-onchain-gateway-api-chains#获取支持的链  
**抓取时间:** 2025-05-27 07:28:07  
**字数:** 110
...
#
GET
https://web3.okx.com/api/v5/dex/pre-transaction/supported/chain
请求参数
#
无
响应参数
